...
interface Recs1Props {
  onBack: () => void;
  onSubmit?: () => void;
}

const Recs1 = ({ onBack, onSubmit }: Recs1Props) => {
    ...
    <div className="flex h-screen w-full overflow-hidden animate-fadeIn">
      ...
      <div className="w-8/12 -mr-24 bg-white flex items-center justify-center px-20 py-16 min-h-[90vh] rounded-r-[60px] rounded-l-none shadow-lg relative z-10">
        ...
        <RecoveryForm 
          ...
          emailLabel="Codigo de recuperar contraseña"
          submitButtonText="Verificar"
          helpTextHighlight="¿Necesitas ayuda?"
          helpText="Contacta a soporte técnico."
