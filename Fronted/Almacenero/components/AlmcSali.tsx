...
import SalidaIcon from '../../assets/Almacenero/Salida/RegSal.svg';
import GuadirIcon from '../../assets/Almacenero/Salida/Guadir.svg';
import CancelIcon from '../../assets/Almacenero/Salida/cancelar.svg';
export default function AlmcSali() {
  ...
  // Eliminados destino y solicitante
  ...
  const materiales = [
    { id: 'MAT-001', nombre: 'Cemento Portland', unidad: 'Bolsa', stock: 150 },
    { id: 'MAT-002', nombre: 'Varillas 3/8"', unidad: 'Unidad', stock: 200 },
    { id: 'MAT-003', nombre: 'Arena fina', unidad: 'm³', stock: 25 },
    { id: 'MAT-004', nombre: 'Ladrillo King Kong', unidad: 'Millar', stock: 5 },
    { id: 'MAT-005', nombre: 'Alambre N°8', unidad: 'kg', stock: 0 },
  ];
  ...
  const handleAgregarProducto = () => {
    ...
    if (materialObj && cantidadNum > materialObj.stock) {
      alert(`Stock insuficiente. Disponible: ${materialObj.stock} ${materialObj.unidad}`);
      return;
    }
    setProductos([
      ...productos,
    ...
    <div className="w-full h-full bg-gray-50 px-4 py-8">
      <div className="max-w-4xl ml-0">
        <div className="flex items-center gap-3 mb-8">
          <h1 className="text-4xl font-bold text-black">SALIDA DE MATERIALES</h1>
          <img src={SalidaIcon} alt="Salida" className="w-16 h-16 ml-4" />
        </div>
        <div className="bg-white rounded-lg shadow p-10 mb-8 w-full">
          <h2 className="text-2xl font-bold text-gray-800 mb-6">Datos de la Salida</h2>
                  ...
                  <div className="absolute z-10 mt-1 w-full bg-white border border-gray-300 rounded-lg shadow-lg max-h-48 overflow-auto">
                    {filteredMateriales.map(material => (
                      ...
                      >
                        ...
                        <div className="text-xs text-gray-500">{material.id} - Stock: {material.stock} {material.unidad}</div>
                      </div>
                    ))}
                  </div>
                )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            {/* Campos de Destino y Solicitante eliminados */}
          </div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {productos.map((prod: ProductoItem, idx: number) => (
        ...
        <div className="flex justify-end gap-4">
          <button
            ...
            className="px-8 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 font-bold text-lg flex items-center gap-2"
          >
            Registrar Salida
            <img src={GuadirIcon} alt="Guardar" className="w-6 h-6 ml-2" />
          </button>
          <button
            type="button"
            onClick={() => {
